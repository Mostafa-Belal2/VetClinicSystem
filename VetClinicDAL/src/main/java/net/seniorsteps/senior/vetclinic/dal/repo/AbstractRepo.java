...
//    private SessionFactory sessionFactory;
    ...
    public List<ClinicEntity> findLick(String keyword) {
        String pattern = "%" + keyword + "%";
        CriteriaBuilder criteriaBuilder = getCurrentSession().getCriteriaBuilder();
        CriteriaQuery<ClinicEntity> cityCriteriaQuery = criteriaBuilder.createQuery(ClinicEntity.class);
        Root<ClinicEntity> root = cityCriteriaQuery.from(ClinicEntity.class);
        cityCriteriaQuery.select(root);
        cityCriteriaQuery.where(
                criteriaBuilder.or(
        ...
        Query<ClinicEntity> cityQuery = getCurrentSession().createQuery(cityCriteriaQuery);
        List<ClinicEntity> cityResultList = cityQuery.getResultList();
